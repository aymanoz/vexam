...
<html lang="en"> 
    ...
    if (!empty($_POST)) {  
        ...
        // Add log record
        $sql_a=$conn ->query( "INSERT INTO log (log_book,log_type,log_data) VALUES  ('CISCO 200-125', 'Add', 'Add Qustion No. $NextID')");
                                            ...
                                            <div class="m-section"> 
                                                ...
                                                <div class="m-form__group form-group">
                                                    ...
                                                    <div class="m-radio-list"> 
                                                        ...
                                                        <label class="form-group m-form__group row">
                                                                <input name="log_img" id="log_img" class="form-control" type="text"> 
                                                            <span></span>
                                                        </label> 
                                                    </div> 
                                                </div> 
